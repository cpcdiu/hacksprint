								...
								<div className="row no-gutters job">
									...
									<div className="col-md-8">
										<div className="job-content">
											...
											<div className="d-flex mt-1">
												<i className="building outline icon"></i>
												<p className="pl-1">Brainstation 23</p>
											</div>
											<div className="d-flex mt-1">
												<i className="map marker alternate icon"></i>
												<p className="pl-1">Dhaka, Bangladesh</p>
								...
								<div class="row no-gutters job">
									<div class="col-md-4">
										<div
											class="logo"
											style={{
												backgroundImage: `url(https://pathao.com/wp-content/uploads/2019/03/Pathao-logo-inverted.png)`,
											}}
										></div>
									</div>
									<div class="col-md-8">
										<div class="job-content">
											...
											<div class="d-flex mt-1">
												...
												<p class="pl-1">5+ Years Experience</p>
											</div>
										</div>
									</div>
								</div>
